...
const HomeLayout = () => {
  ...
  //Getting Form Data From Context
      ...
      <Container maxW="1200px">
        ...
        <Tabs index={page} isLazy lazyBehavior="keepMounted">
          ...
          <Grid display="grid" gridTemplateColumns="3fr 2fr" gap="24px">
            ...
            <DisplayCard
              requisitionDetails={formCtx?.state.requisitionDetails}
              jobDetails={formCtx?.state.jobDetails}
              interviewSettings={formCtx?.state.interviewSettings}
            />
          </Grid>
        </Tabs>
      </Container>
